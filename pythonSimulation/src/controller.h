...
#define IAC_AMP_MAX 10  //(6 * sqrt(2))  // ToDo 6,2Aamp sind in echt nur 4,2Aamp, bei 7 hat Automat ausgelöst -> Phase shift, dann okay, aber nur 50Wout -> 8A, okay
// -> 8.5A sind 55Watt_grid -> 55/0,9=61Wdc -> Ziel:5Aac_sec * 16,4V=82Wdc -> 74Wgrid -> Strom um 34% erhöhen auf 11,39
// -> 10 works reliable, without triggering the circuit breaker -> 65Watt_grid
